      ...
      <div className="container mx-auto py-14">
        ...
        <div className="mt-12 p-6 bg-surface-800 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-3 shrink-0">
            <a
              href="#"
              className="flex items-center gap-2 bg-white text-surface-900 px-4 py-2 rounded-xl text-sm font-medium hover:bg-surface-100 transition-colors"
            >
              <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current" aria-hidden="true">
                <path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.7 9.05 7.4c1.36.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.39-1.32 2.76-2.54 4zm-3.1-17.6c.06 2.04-1.48 3.68-3.38 3.55C10.2 4.14 11.9 2.14 13.95 2.68z" />
              </svg>
              App Store
            </a>
            <a
            ...
            >
              <svg viewBox="0 0 24 24" className="h-5 w-5 fill-current" aria-hidden="true">
                <path d="M3.18 23.76a2 2 0 0 0 2.76.74l10.71-6.18-2.76-2.76L3.18 23.76zm16.62-9.4L5.91.48A2 2 0 0 0 3.18.74L13.89 11.5l5.91-5.91 5.91 5.91-5.91-5.91-5.91 5.91 5.91 5.91-4.26-4.24 9.16-5.28a2 2 0 0 0 0-3.46l-.9-.52z" />
              </svg>
              Google Play
            </a>
          </div>
